...
env = environ.Env(
    ...
    STRIPE_PRO_MONTHLY_PRICE=(str, "19.95"),
...
STRIPE_PRO_MONTHLY_PRICE = env("STRIPE_PRO_MONTHLY_PRICE")
STRIPE_TRIAL_PERIOD_DAYS = env("STRIPE_TRIAL_PERIOD_DAYS")
STRIPE_ENABLED = bool(STRIPE_SECRET_KEY and STRIPE_PRO_PRICE_ID)
